...
const Transmutation = (() => {
   ...
   * @param {number} wwPercent - Written Works average (0–100)
   * @param {number} ptPercent - Performance Tasks average (0–100)
   * @param {number} exPercent - Summative Tests + Term Exam average (0–100)
   * @param {object} weights - { ww, pt, ex } as decimals (e.g., 0.25, 0.50, 0.25)
   */
